...
export default function About() {
  ...
  return (
    ...
    className={` flex  ${localActive === "en" ? "flex-col-reverse xl:flex-row" : "flex-col-reverse xl:flex-row-reverse"} justify-center items-center xl:pl-40  xl:my-0 xl:pr-32 min-h-[90vh] gap-y-5 xl:gap-y-10 gap-x-20`}
  >
    <div className={`flex gap-y-5 xl:gap-y-10 flex-col ${localActive === "en" ? "items-start" : "items-start rtl"} pt-7 xl:pt-36 pb-10 xl:pb-20 px-4 xl:px-0 font-extralight`}>
      ...
      <div className={`${localActive === "en" ? "xl:mr-[-200px]" : "xl:ml-[-90px]"} flex gap-x-4 gap-y-3 flex-col xl:flex-row  pt-5 xl:pt-0 `}>
        <motion.div
        ...
        >
          ...
          <nav className="flex justify-center items-center gap-x-1">
            ...
            <span className="text-accent font-bold xl:text-sm">{t("nationality")}</span>
          </nav>
        </motion.div>
        <motion.div
          variants={fadeIn("up", "tween", 0.5, 1)}
        ...
        >
          <nav className="flex justify-center items-center gap-x-1">
            ...
            <span className="text-accent font-bold xl:text-sm">{t("age")}</span>
          </nav>
          <nav className="flex justify-center items-center gap-x-1">
        ...
        >
          ...
          <nav className="flex justify-center items-center gap-x-1">
            ...
            <span className="text-accent font-bold xl:text-sm">{t("experience")}</span>
          </nav>
        </motion.div>
      </div>
    </div>
